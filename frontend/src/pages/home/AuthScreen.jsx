  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        <h1 className='text-4xl md:text-6xl font-bold mb-4'>Unlimited movies <br /> TV shows, and more</h1>
        <p className='text-lg mb-4'>Watch anywhere. Cancel anytime.</p>
        <p className='mb-4'>Ready to watch? Enter your email to create or restart your membership.</p>

        <form className="flex flex-col py-20 md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
          <input
            type='email'
          ...
          <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <div className="flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2">
